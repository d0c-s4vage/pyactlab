...
class Model(object):
    ...
    def _add_std_fields(self, json):
        ...
        """
        if "url_path" in json and json["url_path"] is not None:
            self.url_path = json["url_path"]
...
class Taskable(object):
    def new_task(self, **params):
        ...
        :task: An instance of a Task model
        :returns: TODO
        """
        return self._client.new_task(self, **params)

class Attachable(object):
    def attach_file(self, file_path_or_data, filename=None):
        self._client.new_attachment(self, file_path_or_data, filename=filename)
...
#        "email":            unicode,
#        "is_completed":     bool,
#        "last_activity_on": int, # time.time utc timestamp
#        "members":          list,
#        "updated_on":       int, # time.time utc timestamp
#        "updated_by_id":    int, # time.time
#
