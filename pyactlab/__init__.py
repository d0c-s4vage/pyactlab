...
class ActLabClient(object):
	...
	def get_users(self, company_id, raw=False):
		"""
		Fetch all users in company specified by company_id
		"""
		res = self._get_cmd("people/{cid}/users".format(cid=company_id))
	...
	def new_task(self, project_id, **params):
		"""
	...
	def _get_api(self, query_params=None):
		"""
	...
	def _post_api(self, query_params=None, post_params=None):
		"""
